...
function main() {
    ...
    var viewModel = {
        ...
        balance: ko.observable(1),
        btc_balance: ko.observable(1),
        min_trade: ko.observable(1),
        upper_limit: ko.observable(1),
        lower_limit: ko.observable(1),
        max_trade: ko.observable(1),
        percentage1m: ko.observable(1),
        percentage2m: ko.observable(1),
        percentage3m: ko.observable(1),
        total_trades: ko.observable(1),
        duration: ko.observable(1),
        transaction_per_min: ko.observable(1),
        cost_amount : ko.observable(1),
        cost_usd : ko.observable(1),
